...
namespace InapescaWeb.Autorizaciones
{
    public partial class Comision_Aut : System.Web.UI.Page
    {
        ...
        public void Carga_Valores()
        {
            ...
            PanelRecTerrestre.Visible = false;
            PanelRecAereo.Visible = false;
            PanelRecAcuatico.Visible = false;
            //clsFuncionesGral.Activa_Paneles(PnlMinDGAIPP, false);
            chkMedioDia.Checked = false;
            chkModifi.Checked = false;

            Label28.Text = clsFuncionesGral.ConvertMayus("Puesto");
            lblEliminar.Text = clsFuncionesGral.ConvertMayus("eliminar");
            ...
            chkModifi.Text = clsFuncionesGral.ConvertMayus("REDUCIR DIAS A PAGAR");
        ...
        {
            List<Entidades.GridView> Lista1 = MngNegocioComision.ComisionadosS(psFolio, psOpcion, psUsuario, psEstatus, psTipoCom, psUbicacion);
        ...
        protected void dplComisionados_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((dplComisionados.SelectedValue != null) | (dplComisionados.SelectedValue != Dictionary.CADENA_NULA) | (dplComisionados.SelectedValue != ""))
            {
                ...
                else
                {
                    ...
                    string lsPermisosEspecialesVIAT = MngNegocioPermisos.ObtienePermisos(dplComisionados.SelectedValue.ToString(), "VIAT");
                    ...
                    {
                        DateTime fechamasdiez = Convert.ToDateTime(Convert.ToDateTime(ultimaFechaComision).AddDays(10));
                        bool DIFERENCIA = (Convert.ToDateTime(lsHoy) > Convert.ToDateTime(Convert.ToDateTime(ultimaFechaComision).AddDays(10)));

                        if (DIFERENCIA) // | (lsPermisosEspecialesVIAT == "VIAT"))
                        {
                            if (((MngNegocioUsuarios.Obtiene_Rol(dplComisionados.SelectedValue.ToString())) != Dictionary.DIRECTOR_GRAL) | (MngNegocioUsuarios.Obtiene_Rol(dplComisionados.SelectedValue.ToString()) != Dictionary.DIRECTOR_JURIDICO) | (MngNegocioUsuarios.Obtiene_Rol(dplComisionados.SelectedValue.ToString()) != Dictionary.DIRECTOR_ADMINISTRACION) | (MngNegocioUsuarios.Obtiene_Rol(dplComisionados.SelectedValue.ToString()) != Dictionary.DIRECTOR_ADJUNTO))
                            {
                                ...
                                {
                                    //CountPVIAT = MngNegocioPermisos.obtieneCountPermisos(dplComisionados.SelectedValue.ToString(),"VIAT");
                                    //CountSVIAT = MngNegocioPermisos.obtieneCountSolicitudes(dplComisionados.SelectedValue.ToString());
                                    //if(CountSVIAT<CountPVIAT)
                                    //{
                                    x = true;
                                    //}
                    ...
                    else
                    {
                        ...
                        int contSolRegistradas = Convert.ToInt16(MngNegocioComision.Solicitudes_Registradas(dplComisionados.SelectedValue.ToString(), lsHoy));
                        if (totalDias >= clsFuncionesGral.Convert_Double(clsFuncionesGral.Convert_Decimales(Dictionary.DIAS_ANUALES)))
                        {
                            ...
                            //CountPOFMAY = MngNegocioPermisos.obtieneCountPermisos(dplComisionados.SelectedValue.ToString(), "OFMAY");
                            //CountSVIAT = MngNegocioPermisos.obtieneCountSolicitudes(dplComisionados.SelectedValue.ToString());
                            ...
                            {
                                int lsCantPermisos = MngNegocioPermisos.obtieneCantPermisos(dplComisionados.SelectedValue.ToString(), "OFMAY");
                                if (contSolRegistradas < lsCantPermisos)
                                {
                                    //if (CountSVIAT < CountPOFMAY)
                                    //{
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            PanelPasajesModif.Visible = false;
            txtPasajeModif.Text = Dictionary.NUMERO_CERO;
        ...
        public void Carga_Panel(string psFolio, string psUbicacion, string psOpcion, string psPermisosAdmin)
        {
            ...
            if ((detalleComision.Tipo_Pago_Viatico == null) | (detalleComision.Tipo_Pago_Viatico == Dictionary.CADENA_NULA) | (detalleComision.Tipo_Pago_Viatico == Dictionary.NUMERO_CERO))
            {
                ...
                clsFuncionesGral.Llena_Lista(dplTipoPagoViaticos, clsFuncionesGral.ConvertMayus("SELECCIONE|deposito a cuenta"));
            ...
            */
            ...
            if ((psOpcion == Dictionary.VOBO) | (psPermisosAdmin == Dictionary.PERMISO_ADMINISTRADOR_LOCAL))//VOBO
            {
                ...
                string config = MngNegocioConfiguraciones.Obtiene_Dep_Configuracion(detalleComision.Ubicacion_Autoriza, "FIRMA1");
                if ((detalleComision.Ubicacion_Autoriza == "4000") || (detalleComision.Ubicacion_Autoriza == config))
                {
        ...
        protected void dplVehiculo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string[] DatosVehiculoAut = new string[9];
            Ubicacion oUbicacionTrans = MngNegocioAdscripcion.ObtieneDatosUbicacion("1000");//Session["Crip_Ubicacion"].ToString());
            if ((dplTipoTAUt.SelectedValue.ToString() == "AV") | (dplTipoTAUt.SelectedValue.ToString() == "VB") | (dplTipoTAUt.SelectedValue.ToString() == "VP") | (dplTipoTAUt.SelectedValue.ToString() == "VA") | (dplTipoTAUt.SelectedValue.ToString() == "VAA") | (dplTipoTAUt.SelectedValue.ToString() == "VAB") | (dplTipoTAUt.SelectedValue.ToString() == "OAP") | (dplTipoTAUt.SelectedValue.ToString() == "VAP") | (dplTipoTAUt.SelectedValue.ToString() == "VO") | (dplTipoTAUt.SelectedValue.ToString() == "AVE"))
            {

                DatosVehiculoAut = MngNegocioTransporte.Descrip_Trans("TER", "VO", "1000", lsVehiculoAut);// Session["Crip_Ubicacion"].ToString(), lsVehiculoAut);
        ...
        protected void dplZonas_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((zona == "1") || (zona == "2") || (zona == "3") || (zona == "4") || (zona == "5") || (zona == "6") || (zona == "9") || (zona == "10") || (zona == "11") || (zona == "12") || (zona == "13"))
            {
                List<Entidad> lstLista = MngNegocioViaticos.Metodo_Viaticos(true);
                List<Entidad> lstLista1 = new List<Entidad>();

                foreach (Entidad l in lstLista)
                {
                    if (l.Codigo == "0")
                    {
                        ;
                ...
                dplPagos.DataSource = lstLista1;
                dplPagos.DataTextField = Dictionary.DESCRIPCION;
                dplPagos.DataValueField = Dictionary.CODIGO;
                dplPagos.DataBind();
                lstLista1 = null;
            }
            if ((zona == Dictionary.Zona_Dolares) || (zona == Dictionary.Zona_Euros))
            {
                clsFuncionesGral.Activa_Paneles(pnlMixtosDias, false);
                ...
                if (zona == Dictionary.Zona_Dolares)
                {
                    txtDenominacion.Text = Dictionary.Dolares;
                }
                else
                {
                    txtDenominacion.Text = Dictionary.Euros;
                }
            ...
            {
                if ((zona == "16") || (zona == "17"))//investigadores  rural
                {
                ...
                else if ((zona == "20") || (zona == "21")) //MIXTO (INVESTIGADORES + PERSONAL EN CAMPO )
                {
                    List<Entidad> lstLista = MngNegocioViaticos.Metodo_Viaticos(true);
                    List<Entidad> lstLista1 = new List<Entidad>();
                ...
                else if ((zona == "22") || (zona == "23"))//MIXTO (INVESTIGADORES +PERSONAL EN CAMPO + RURAL ) 
                {
                    List<Entidad> lstLista = MngNegocioViaticos.Metodo_Viaticos(true);
                    List<Entidad> lstLista1 = new List<Entidad>();
        ...
        protected void chkTerrestre_CheckedChanged(object sender, EventArgs e)
        {
            if (chkTerrestre.Checked)
            {
                ...
                dplClaseAut.DataSource = MngNegocioTransporte.ObtieneClaseTrans("1000");//Session["Crip_Ubicacion"].ToString());
        ...
        protected void imgClaseTAut_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                dplTipoTAUt.DataSource = MngNegocioTransporte.ObtieneTipoTrans(lsClaseTAut, "1000"); //Session["Crip_Ubicacion"].ToString());
        ...
        protected void imgTipoTAut_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                if ((TipoTAut == "AV") | (TipoTAut == "VB") | (TipoTAut == "VP") | (TipoTAut == "VA") | (TipoTAut == "VAA") | (TipoTAut == "VAB") | (TipoTAut == "OAP") | (TipoTAut == "VAP") | (TipoTAut == "VO") | (TipoTAut == "AVE"))
                {
                    claseT = Dictionary.TERRESTRE;
                    TipoT = Dictionary.TIPO_OFICIAL;
                    Label31.Visible = true;
                    dplVehiculo.Visible = true;
                    dplVehiculo.DataSource = MngNegocioTransporte.Descripcion_Transporte(claseT, TipoT, "1000");//Session["Crip_Ubicacion"].ToString());
                    dplVehiculo.DataTextField = Dictionary.DESCRIPCION;
                    dplVehiculo.DataValueField = Dictionary.CODIGO;
                    dplVehiculo.DataBind();

                    if ((TipoTAut == "AV") | (TipoTAut == "BA") | (TipoTAut == "PP") | (TipoTAut == "VAB") | (TipoTAut == "OAP") | (TipoTAut == "AAP"))
                    {
                        txtOrigen_Ter.Text = "";
                        PanelRecTerrestre.Visible = true;
                        PanelRecAereo.Visible = true;

                    }

                    if ((TipoTAut == "VO") | (TipoTAut == "AP") | (TipoTAut == "AB") | (TipoTAut == "VB") | (TipoTAut == "VP") | (TipoTAut == "VAP") | (TipoTAut == "ABP"))
                    {
                        PanelRecTerrestre.Visible = true;
                    }
                    if ((TipoTAut == "VA") | (TipoTAut == "BEM") | (TipoTAut == "APE"))
                    {

                        PanelRecTerrestre.Visible = true;
                        PanelRecAcuatico.Visible = true;

                    }
                    if ((TipoTAut == "VAA") | (TipoTAut == "AAA") | (TipoTAut == "PAA") | (TipoTAut == "AVE"))
                    {
                ...
                else
                {
                    ...
                    DatosVehiculoAut = MngNegocioTransporte.Descrip_Trans(dplClaseAut.SelectedValue.ToString(), TipoTAut, "1000", Dictionary.CADENA_NULA);// Session["Crip_Ubicacion"].ToString(), Dictionary.CADENA_NULA);
        ...
        protected void btnAccion_Click(object sender, EventArgs e)
        {
            ...
            if ((Session["Crip_Opcion"].ToString() == Dictionary.VOBO) | (permisos == Dictionary.PERMISO_ADMINISTRADOR_LOCAL))
            {
                ...
                objProyecto = MngNegocioProyecto.ObtieneDatosProy(detalleComision.Dep_Proy, detalleComision.Proyecto, year);
                //  Valida_Campos(error, permisos, detalleComision, objProyecto);
                /*Vlidacion de campos*/
                //  pbError = false;
                string config = Dictionary.CADENA_NULA;
                //config = MngNegocioConfiguraciones.Obtiene_Dep_Configuracion(Session["Crip_UbicacionAut"].ToString(), "FIRMA1");
                //if ((Session["Crip_UbicacionAut"].ToString() == Dictionary.DGAIPP) || (Session["Crip_UbicacionAut"].ToString() == config))
                //{
                //    //detalleComision.Oficio_DGAIPP=;
                //}
                //else 
                //{
                //    detalleComision.Oficio_DGAIPP="0";
                //}
                ...
                if ((detalleComision.Zona_Comercial == null) | (detalleComision.Zona_Comercial == Dictionary.CADENA_NULA))// | (Detalle_Comision.Zona_Comercial == Dictionary.NUMERO_CERO))
                {
                    ...
                    if (lsZonaComer == string.Empty)
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Favor de Seleccionar la Zona de Comisión y la Forma de Pago');", true);
                        return;
                    }
                    else
                    {
                        ...
                        else if (lsZonaComer == "15")
                        {
                            ...
                            detalleComision.Dias_Pagar = Dictionary.NUMERO_CERO;
                            detalleComision.Singladuras = Dictionary.NUMERO_CERO;
                            detalleComision.Total_Viaticos = Dictionary.NUMERO_CERO;
                    ...
                    else if (lsZonaComer == Dictionary.Zona_Dolares)
                    {
                        detalleComision.Dias_Rural = Dictionary.NUMERO_CERO;
                        ...
                        else if ((lsZonaComer == Dictionary.Zona_Euros) || (lsZonaComer == Dictionary.Zona_Dolares))
                        {
                            detalleComision.Dias_Rural = Dictionary.NUMERO_CERO;
                            detalleComision.Dias_Comercial = txtDiasTotalaPagar.Text;
                            detalleComision.Dias_50 = Dictionary.NUMERO_CERO;
                            ...
                            if ((txtTarifa.Text == null) || (txtTarifa.Text == Dictionary.CADENA_NULA))
                            {
                                error = true;
                                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Coloque la atarifa autorizada.');", true);
                                return;
                            }
                            else if ((!clsFuncionesGral.IsNumeric(txtTarifa.Text)))
                            {
                                error = true;
                                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Tarifa no es númerica');", true);
                                return;
                            }

                            if ((txtTipoCambio.Text == null) || (txtTipoCambio.Text == Dictionary.CADENA_NULA))
                            {
                                error = true;
                                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Coloque el tipo de cambio autorizado al día de Hoy.');", true);
                                return;
                            }
                            else if ((!clsFuncionesGral.IsNumeric(txtTipoCambio.Text)))
                            {
                                error = true;
                                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Tipo Cambio no es númerica');", true);
                                return;
                            }
                ...
                {
                    if (dplTipoPagoViaticos.SelectedIndex == 0)
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Seleccione tipo de pago ');", true);
                        return;
                    }
                    else
                    {
                ...
                if (pnlCombustible.Visible)
                {
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if ((detalleComision.Pago_Combustible == null) | (detalleComision.Pago_Combustible == Dictionary.CADENA_NULA))
                            {
                                if (txtCombusAut.Text == Dictionary.NUMERO_CERO)
                                {
                                    if (txtCombustSol.Text == Dictionary.NUMERO_CERO)
                                    {
                                        detalleComision.Pago_Combustible = dplPagoCombustibles.SelectedValue.ToString();
                                    }
                                    else
                                    {
                                        error = true;
                                        ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('No inserto el importe de combustible autorizado');", true);
                                        return;
                    ...
                    if (pnlCombustEfe.Visible)
                    {
                        ...
                        if ((clsFuncionesGral.Convert_Double(txtCombustEfe.Text) + clsFuncionesGral.Convert_Double(txtCombusVales.Text)) < clsFuncionesGral.Convert_Double(txtCombusAut.Text))
                        {
                            ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('La suma del combustible efectivo y en vales no puede ser menor del importe autorizado ');", true);
                            return;
                        }
                        else
                        {
                ...
                if (pnlVehiculo.Visible)
                {
                    ...
                    detalleComision.Origen_Terrestre = Dictionary.CADENA_NULA;
                    detalleComision.Origen_Aereo = Dictionary.CADENA_NULA;
                    detalleComision.Origen_Dest_Acu = Dictionary.CADENA_NULA;
                    if (PanelRecTerrestre.Visible)
                    {

                        if ((txtRecorridoTerrestre.Text == null) | (txtRecorridoTerrestre.Text == Dictionary.CADENA_NULA))
                        {
                            error = true;
                            ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Recorrido transporte terrestre no puede ser vacio');", true);
                            return;
                        ...
                        else
                        {
                            ...
                            //    error = false;
                            editado = false;
                            if (detalleComision.Origen_Terrestre != txtRecorridoTerrestre.Text) editado = true;
                            if (editado) detalleComision.Origen_Terrestre = txtRecorridoTerrestre.Text;
                        }

                    }
                    if (PanelRecAereo.Visible)
                    {
                        if ((TxtRecorridoAereo.Text == null) | (TxtRecorridoAereo.Text == Dictionary.CADENA_NULA))
                        {
                            error = true;
                            ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Recorrido transporte aereo no puede ser vacio');", true);
                            return;
                        ...
                        else
                        {
                            ...
                            //   error = false;
                            editado = false;
                            if (detalleComision.Origen_Aereo != TxtRecorridoAereo.Text) editado = true;
                            if (editado) detalleComision.Origen_Aereo = TxtRecorridoAereo.Text;
                        }
                    }

                    if (PanelRecAcuatico.Visible)
                    {
                        if ((txtRecorridoAcuatico.Text == null) | (txtRecorridoAcuatico.Text == Dictionary.CADENA_NULA))
                        {
                            error = true;
                            ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Recorrido transporte acuatico no puede ser vacio');", true);
                            return;
                        ...
                        else
                        {
                            ...
                            //  error = false;
                            editado = false;
                            if (detalleComision.Origen_Dest_Acu != txtRecorridoAcuatico.Text) editado = true;
                            if (editado) detalleComision.Origen_Dest_Acu = txtRecorridoAcuatico.Text;
                        }
                    }

                    detalleComision.Ubicacion_Trans_Aut = Dictionary.DG;
                }
                else
                {
            ...
            if (!error)
            {
                if ((Session["Crip_Opcion"].ToString() == Dictionary.VOBO) | (MngNegocioPermisos.ObtienePermisos(Session["Crip_Usuario"].ToString(), Dictionary.PERMISO_ADMINISTRADOR_LOCAL) == Dictionary.PERMISO_ADMINISTRADOR_LOCAL))
                {
                    ...
                    foreach (System.Web.UI.WebControls.GridViewRow r in GridView1.Rows)
                    {
                        ...
                        string lsPermisosEspeciales = MngNegocioPermisos.ObtienePermisos(objComision.Comisionado, "VIAT24");
                        if (objComision.Territorio == Dictionary.Nacional)
                        {
                            if (objComision.Zona_Comercial != "15")
                            {
                                if (objComision.Zona_Comercial != "0")
                                {
                                    if ((Convert.ToDouble(objComision.Dias_Pagar) > Convert.ToDouble(Dictionary.DIAS_NACIONALES)) || (Convert.ToDouble(objComision.Dias_Reales) > Convert.ToDouble(Dictionary.DIAS_NACIONALES)))
                                    {
                                        if ((lsPermisosEspeciales != "VIAT24"))
                                        {
                                            ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('La duración maxima de las comisiones en que se autorice el pago de viáticos y pasajes no puede exceder de siete días naturales para comisiones en territorio nacional');", true);
                                            return;
                                        }
                                    }
                                }
                        ...
                        lsPermisosEspeciales = MngNegocioPermisos.ObtienePermisos(objComision.Comisionado, "VIAT20");

                        if (objComision.Territorio == Dictionary.Internacional)
                        {
                            if (Convert.ToDouble(objComision.Dias_Pagar) > Convert.ToDouble(Dictionary.DIAS_INTERNACIONALES) || (Convert.ToDouble(objComision.Dias_Reales) > Convert.ToDouble(Dictionary.DIAS_INTERNACIONALES)))
                            {
                                if ((lsPermisosEspeciales != "VIAT20"))
                                {
                                    ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('La duración maxima de las comisiones en que se autorice el pago de viáticos y pasajes no puede exceder de 10 días naturales para comisiones realizadas en el extranjero');", true);
                                    return;
                                }
                            }
                        }
                        ...
                        if (detalleComision.Ubicacion_Autoriza == Dictionary.DGAIPP)
                        {
                            if (detalleComision.Oficio_DGAIPP == Dictionary.NUMERO_CERO || detalleComision.Oficio_DGAIPP == Dictionary.CADENA_NULA)
                            {
                                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Favor de enviar Formato de oficio de la DIPP debidamente firmado al correo soporte.smaf@gmail.com, con el fin de que se agregue el número de minutario de la DIPP a esta solicitud de comisión y posteriormente realice la ministración correspondiente');", true);
                                return;
                            }
                            else
                            {
                                objComision.Oficio_DGAIPP = detalleComision.Oficio_DGAIPP;
                            }
                        }
                        else
                        {
                        ...
                        else if ((objComision.Zona_Comercial == "15") & ((objComision.Combustible_Efectivo == Dictionary.NUMERO_CERO) & (objComision.Peaje == Dictionary.NUMERO_CERO) & (objComision.Pasaje == Dictionary.NUMERO_CERO)))
                        {
                            objComision = MngNegocioComision.Detalle_Comision(Session["Crip_Folio"].ToString(), detalleComision.Ubicacion, usuario, "5");
                            objComision.Estatus = "5";
                        }
                    ...
                    foreach (Entidad l in ListaAutoriza)
                    {
                        if (l.Codigo != "")
                        {
                            ...
                            if (l.Codigo == usu.Usser)
                            {
                                ...
                                string usMinistrador = Dictionary.USUARIO_MINISTRADOR;
                                envio_mail = clsMail.Mail_Comision(Session["Crip_Secretaria"].ToString(), Session["Crip_Organismo"].ToString(), Session["Crip_Ubicacion"].ToString(), objProyecto.Dependencia, usMinistrador, "Soporte SMAF ", Session["Crip_Nombre"].ToString() + " " + Session["Crip_ApPat"].ToString() + " " + Session["Crip_ApMat"].ToString(), listaGrid, detalleComision.Clase_Trans, detalleComision.Tipo_Trans, detalleComision.Ubicacion_Transporte, detalleComision.Vehiculo_Solicitado, detalleComision.Descrip_vehiculo, Convert.ToString(detalleComision.Folio), detalleComision.Fecha_Inicio, detalleComision.Fecha_Final, detalleComision.Lugar, objProyecto.Responsable, objProyecto.Descripcion, TipoMail, Session["Crip_Rol"].ToString(), Session["Crip_Cargo"].ToString(), MailBandera);
                            }
                            else
                            {
                                usu = null;
