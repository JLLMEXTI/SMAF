                            ...
                            <tr>
                                <td colspan="2">
                                    <table border="0" width="100%">
                                        ...
                                        <!--INICIA PANEL INTERNACIONAL-->
                                 <asp:Panel ID="pnlInternacional" runat="server">
                                        <tr>
                                        <td >
                                       <h4>
                                            <asp:Label ID="Label29" runat="server" Text="Denominacion"></asp:Label>
                                       </h4>
                                        </td>
                                        <td align ="left">
                                            <asp:TextBox ID="txtDenominacion" Width ="100%"  runat="server" Enabled="false"> </asp:TextBox>
                                        </td>
                                        <td>
                                        <h4>
                                            <asp:Label ID="Label30" runat="server" Text="Tarifa Autorizada"></asp:Label>
                                        </h4>
                                        </td>
                                        <td align ="left">
                                           <asp:TextBox ID="txtTarifa" Width ="80%" runat="server"></asp:TextBox>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td colspan ="2">
                                        <h5>
                                            <asp:Label ID="Label39" runat="server" Text="Tipo Cambio a fecha Actual"></asp:Label>
                                        </h5>
                                        </td>
                                        <td colspan ="2" align ="left">
                                        <asp:TextBox ID="txtTipoCambio" runat="server" Width ="30%"></asp:TextBox>
                                        </td>
                                        </tr>
                                       </asp:Panel>
                                        <!--TERMINA PANEL INTERNACIONAL-->
                            ...
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlVehiculo" runat="server">
                                        ...
                                        <asp:Panel ID="PanelRecTerrestre" runat="server" Visible="false">
                                            <tr>
                                                <td class="style15">
                                                    <h1>
                                                        <asp:Label ID="lblRecorridoTerrestre" runat="server" Text="Recorrido Terrestre: "></asp:Label></h1>
                                                </td>
                                                <td>
                                        ...
                                        <asp:Panel ID="PanelRecAereo" runat="server" Visible="false">
                                            <tr>
                                                <td class="style15">
                                                    <h1>
                                                        <asp:Label ID="lblRecorridoAereo" runat="server" Text="Recorrido Aereo: "></asp:Label></h1>
                                                </td>
                                                <td>
                                        ...
                                        <asp:Panel ID="PanelRecAcuatico" runat="server" Visible="false">
                                            <tr>
                                                <td class="style15">
                                                    <h1>
                                                        <asp:Label ID="lblRecorridoAcuatico" runat="server" Text="Recorrido Acuatico"></asp:Label></h1>
                                                </td>
                                                <td>
                                        ...
                                        <asp:Panel ID="PanelPasajesModif" runat="server" Visible="false">
                                            <tr>
                                                <td class="style15">
                                                    <h1>
                                                        <asp:Label ID="Label40" runat="server" Text="CUOTA PASAJES: "></asp:Label></h1>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtPasajeModif" runat="server" Width="85%"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </asp:Panel>
                                    </asp:Panel>
