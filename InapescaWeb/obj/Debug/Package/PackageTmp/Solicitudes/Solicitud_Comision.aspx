                    ...
                    <asp:MultiView runat="server" ID="mvComision">
                            ...
                            <table id="Table1">
                                ...
                                <asp:Panel ID="pnlproyectos" runat="server">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="dplDep" runat="server" Width="85%" AutoPostBack="True"
                                                        OnSelectedIndexChanged="dplDep_SelectedIndexChanged">
                                            </asp:DropDownList>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <div id="Div1" class="DivTableHeader">
                                                            <table cellspacing="0" cellpadding="0" rules="all" border="0" id="Table7" class="tblHeader">
                                                                <tr>
                                                                    <td style="width: 65%; text-align: center">Meta
                                                                    </td>
                                                                    <td style="width: 15%; text-align: center">Limpiar Lista
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div id="DivTableHeader">
                                                    <table cellspacing="0" cellpadding="0" rules="all" border="0" id="tblHeader">
                                                        <tr>
                                                            <td style="width: 40%; text-align: center">Comisionado
                                                            </td>
                                                            <td style="width: 20%; text-align: center">Usuario
                                                            </td>
                                                            <td style="width: 25%; text-align: center">Adscripción
                                                            </td>
                                                            <td style="width: 15%; text-align: center">Eliminar
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                        ...
                        <asp:View ID="vwUbicacion" runat="server">
                            <table id="Table3" border="0">
                                ...
                                <!--Inicia panel de ampliacion -->
                                <tr>
                                    <td colspan="2">
                                        <h2>
                                            <asp:CheckBox ID="chkAMpliacion" Text="Ampliacion de Comisión" runat="server" AutoPostBack="True" OnCheckedChanged="chkAMpliacion_CheckedChanged" />
                                        </h2>
                                    </td>
                                </tr>
                                <asp:Panel ID="pnlAmpliacion" runat="server">
                                   <tr>
                                        <td colspan="2">
                                            <h4>
                                        ...
                                        <td colspan="2" align="center">
                                            <table id="Table6" border="0">
                                                <tr>
                                                    <td>
                                                        <b>
                                                            <asp:Label ID="Label7" runat="server" Text="URL INAPESCA"></asp:Label></b>
                                                    </td>
                                                    <td>
                                                        <b>
                                                            <asp:Label ID="Label8" runat="server" Text="CENTRO DE COSTOS"></asp:Label></b>
                                                    </td>
                                                    <td>
                                                        <b>
                                                            <asp:Label ID="Label9" runat="server" Text="NÚM. OFICIO"></asp:Label></b>
                                                    </td>
                                                    <td>
                                                        <b>
                                                            <asp:Label ID="Label10" runat="server" Text="AÑO"></asp:Label></b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label11" runat="server" Text="RJL-INAPESCA-"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtCentroCosto" Width="80%" runat="server"></asp:TextBox> -
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtNumOfiAmpliacion" Width="80%" runat="server"></asp:TextBox> -
                                                    </td>
                                                    <td>
...
<br />
                                ...
                                <!--termina panel de ampliacion -->
                                <!--inicia panel de tipo comision-->
                                     <tr>
                                            <td >
                                              <h1>
                                            ...
                                            <td align="left">
                                                <asp:DropDownList ID="dplTipoComision" runat="server" Width="100%" 
                                                    AutoPostBack = "true" 
                                                    onselectedindexchanged="dplTipoComision_SelectedIndexChanged" 
                                                    style="height: 22px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                <!--termina panel de tipo de comision-->
                               
                                <!--inicia modificacion de pais-->
                                <asp:Panel ID="pnlPais" runat="server">
                                
                                <tr>
                                <td>
                                      <h1>
                                            <asp:Label ID="Label13" runat="server">Pais :</asp:Label></h1>
                                </td>
                                <td>
                                 <asp:TextBox ID="txtPais" runat="server" Width="100%" Style="text-transform: uppercase"
                                            MaxLength="250"></asp:TextBox>
                                </td>
                                </tr>
                                </asp:Panel>
                                <!--termina modificacion de pais-->
                                <tr>
                                    <td class="style3">
                                        <h1>
                                ...
                                <!--inicia modificacion de estado-->
                                <asp:Panel ID="pnlEstado" runat="server">
                                
                                <tr>
                                <td>
                                   <h1>
                                            <asp:Label ID="Label14" runat="server">Estado :</asp:Label></h1>
                                </td>
                                <td>
                                   <asp:DropDownList ID="dplEstado" runat="server" Width="100%">
                                                </asp:DropDownList>
                                </td>
                                </tr>
                                </asp:Panel>
                                <!--termina modificacion de estado-->
                                <tr>
                                    <td colspan="2">
                            ...
                            <table id="Table4" border="0">
                                <tr>
                                    <td colspan="2">
                                        ...
                                        </h2><asp:Label ID="lblTransporte" runat="server"></asp:Label>
                                    </td>
                                </tr>
