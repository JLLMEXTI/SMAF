...
*/|
-->
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alta_CuentaContable.aspx.cs" Inherits="InapescaWeb.Catalogos.Alta_CuentaContable" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Actualizar Cuenta Contable</title>
            ...
            <div id="side-b">
                <table id="Table1" border="0">
                    ...
                    <tr>
                        ...
                        <td align="left">
                          <asp:TextBox ID="CuentaBanc" runat="server" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
