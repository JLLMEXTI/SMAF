<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_Comprobaciones.aspx.cs"
    Inherits="InapescaWeb.Comprobaciones.Menu_Comprobaciones" %>
                ...
                <div id="side-b">
                    <div style="border: 1px solid #ddd; height: auto;">
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <td colspan="5">
                                    <asp:Panel ID="PanelNocomprobadas" runat="server">
                                        <table border="0" width="100%">
                                            <tr>
                                                <td style="text-align: center;">
                                                    <hr />
                                                    <h2><asp:Label ID="Label3" runat="server" CssClass="h1Azul" Text="COMPROBACIONES PENDIENTES"></asp:Label></h2>
                                                    <hr />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GvMenuNocomprobadas" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                                        <AlternatingRowStyle BackColor="White" />

                                                        <Columns>
                                                            <asp:HyperLinkField DataNavigateUrlFields="Archivo" DataNavigateUrlFormatString="~/Comprobaciones/Comprobacion2017.aspx?folio={0}|9" DataTextField="Archivo" HeaderText="Archivo" ItemStyle-Width="30%" />

                                                            <asp:BoundField DataField="Folio" HeaderText="Ampli" ItemStyle-Width="5%" />
                                                            <asp:BoundField DataField="Lugar" HeaderText="Lugar" ItemStyle-Width="20%" />
                                                            <asp:BoundField DataField="Periodo" HeaderText="Periodo" ItemStyle-Width="25%" />
                                                            <asp:BoundField DataField="Total_Viaticos" HeaderText="Total" ItemStyle-Width="5%" />
                                                            <asp:BoundField DataField="Tipo_Pago_Viatico" HeaderText="Tipo" ItemStyle-Width="5%" />
                                    ...
                                    <asp:Panel ID="PanelOtros" runat="server">
                                        <table border="0" width="100%">
                                            <tr>
                                                <td style="text-align: center;">
                                                    <hr />
                                                    <h2><asp:Label ID="Label4" runat="server" CssClass="h1Azul" Text="COMPROBACIONES REALIZADAS"></asp:Label></h2>
                                                    <hr />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GvMenuOtros" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:HyperLinkField DataNavigateUrlFields="Archivo" DataNavigateUrlFormatString="~/Comprobaciones/Comprobacion2017.aspx?folio={0}" DataTextField="Archivo" HeaderText="Archivo" ItemStyle-Width="30%" />
                                                            <asp:BoundField DataField="Folio" HeaderText="Ampli" ItemStyle-Width="5%" />
                                                            <asp:BoundField DataField="Lugar" HeaderText="Lugar" ItemStyle-Width="20%" />
                                                            <asp:BoundField DataField="Periodo" HeaderText="Periodo" ItemStyle-Width="25%" />
                                                            <asp:BoundField DataField="Total_Viaticos" HeaderText="Total" ItemStyle-Width="5%" />
