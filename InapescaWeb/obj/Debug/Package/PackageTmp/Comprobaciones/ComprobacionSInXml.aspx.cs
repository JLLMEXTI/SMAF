...
{
    public partial class ComprobacionSInXml : System.Web.UI.Page
    {
        string lsFolio;
        ...
        protected void lnkAddFacturas_Click(object sender, EventArgs e)
        {
            ...
            if ((txtUUID.Text  == Dictionary.CADENA_NULA) | (txtUUID.Text  == null))
            {
                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Folio Fiscal es nesesario.');", true);
                return;
            }

            if ((txtImporteFac.Text  == Dictionary.CADENA_NULA) | (txtImporteFac.Text  == null))
            {
                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Importe nesesario');", true);
                return;
            }
            else if (!clsFuncionesGral.IsNumeric(txtImporteFac.Text ))
            {
           ...
           // if (!fuplXML.HasFile)
            //{
             //   ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Archivo de validacion de sat es nesesario');", true);
              //  return;
           // }
            //else
            //{
            if (fuplXML.HasFile)
            {
                String fileExtension1 = System.IO.Path.GetExtension(fuplXML.FileName).ToLower();
            ...
            if ((fileOk) & (xmlOK))
            {
                ...
                try
                {
                    ...
                    if ((existe == "") | (existe == null))
                    {
                        ...
                        totalImporteXml = clsFuncionesGral.Convert_Double ( txtImporteFac .Text );
                        if (fuplXML.HasFile)
                        {
                        ...
                        //MngNegocioComision.Inserta_Comprobacion_Comision(detalleComision.Oficio, detalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), oXml.FECHA_TIMBRADO, detalleComision.Proyecto, detalleComision.Dep_Proy, dplFiscales.SelectedValue.ToString(), lsClvConcepto, lsConcepto, fuplPDF.FileName, clsFuncionesGral.ConvertString(totalImporteXml), fuplXML.FileName, lsConcepto + "|factura|" + fuplPDF.FileName.Replace(".pdf", ""), fuplPDF.FileName.Replace(".pdf", ""), ticket, oXml.TIMBRE_FISCAL);
                        sube = MngNegocioComision.Inserta_Comprobacion_Comision(detalleComision.Oficio, detalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), TextBox1.Text, detalleComision.Proyecto, detalleComision.Dep_Proy, dplFiscales.SelectedValue.ToString(), lsClvConcepto, lsConcepto, fuplPDF.FileName, clsFuncionesGral.ConvertString(totalImporteXml), fuplXML.FileName, "01","01",lsConcepto + "|factura|" + fuplPDF.FileName.Replace(".pdf", ""), fuplPDF.FileName.Replace(".pdf", ""), "", txtUUID.Text,detalleComision.Periodo);
                        Crear_Tabla();
                        tblDetalle.Rows.Clear();
                        Carga_Detalle(detalleComision);
                        detalleComision = null;
        ...
        protected void lnkAgregaAttNota_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "2", "16", dplConcepto.SelectedItem.Text, fupdPeajes.FileName, clsFuncionesGral.Convert_Decimales(txtImportePeaje.Text), "","01","01", "Peajes|Atenta Nota|" + clsFuncionesGral.ConvertMinus(fupdPeajes.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdPeajes.FileName).Replace(".pdf", ""), "", "",DetalleComision.Periodo );
        ...
        protected void lnkAgregaNoFiscal_Click(object sender, EventArgs e)
        {
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('No uede subir el 10% ya que en estas tarifas no aplica.');", true);
                return;
            }
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "12", "CERTIFICADO DE TRANSITO", clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(txtImporteCertificado.Text), "", "01", "01", "CERTIFICADO-" + clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), "", "", DetalleComision.Periodo);
                    // Calcula();
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "12", "DESPACHO DE CAPITANIA DE PUERTO", clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(grandTotal.ToString()), "", "01", "01", "DESPACHO-" + clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), "", "", DetalleComision.Periodo);
                    // Calcula();
        ...
        public void Sube_Informe_Comision()
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    string[] lsOficio = new string[5];
                    lsOficio = Session["Crip_Folio"].ToString().Split(new Char[] { '-' });
                    if (Convert.ToDateTime(lsHoy) < Convert.ToDateTime("2021-05-05"))
                    {
                        MngNegocioComision.Inserta_Informe_Comision(lsOficio[3], DetalleComision.Ubicacion, DetalleComision.Comisionado, DetalleComision.Ubicacion_Comisionado, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "1", fupdlComision.FileName, fupdlComision.FileName, fupdlComision.FileName, fupdlComision.FileName, lsHoy, lsHoy, DetalleComision.Periodo);

                    }
                    else
                    {
                        MngNegocioComision.Inserta_Informe_Comision(lsOficio[3], DetalleComision.Ubicacion_Autoriza, DetalleComision.Comisionado, DetalleComision.Ubicacion_Comisionado, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "1", fupdlComision.FileName, fupdlComision.FileName, fupdlComision.FileName, fupdlComision.FileName, lsHoy, lsHoy, DetalleComision.Periodo);
                    }    
        ...
        public void Carga_Detalle(Comision poComision)
        {
             ...
             * zona 12 medio dia mandos medios 1000
             * zona 14 rural 550
             * zona 15 singladuras
            ...
            if ((poComision.Zona_Comercial == "20"))
            {
                ...
                string[] lsCadena = new string[5];
                lsCadena = Session["Crip_Folio"].ToString().Split(new Char[] { '-' });
                double reintegro = (x - clsFuncionesGral.Convert_Double(MngNegocioComision.Obtiene_Importe_total(Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsCadena[0])));
        ...
        public void Carga_Valores(Comision poComision)
        {
            ...
            Label23.Text = clsFuncionesGral.ConvertMayus("UUID :");
            Label26.Text = clsFuncionesGral.ConvertMayus("Importe $ :");
            Label27.Text = clsFuncionesGral.ConvertMayus("Fecha Factura :");
