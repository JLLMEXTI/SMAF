<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PagaViaticos.aspx.cs" Inherits="InapescaWeb.Pagos.PagaViaticos" %>
                ...
                <table id="Table1" border="0" width="100%" cellspacing="1" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <asp:TextBox ID="dplSiglas" runat="server"></asp:TextBox>
                            -
                       ...
                       <!--  <asp:Panel ID="pnlDatosComision" runat="server">-->
                                <table width="100%">
                                   ...
                                   <!--combustible-->
                                    ...
                                    <tr>
                    <td colspan ="6" align ="right">
                        <asp:Button ID="btnPagar" runat="server" Text="Registrar Pagos" onclick="btnPagar_Click" 
                          />
                    </td>
                    </tr>

                                    <!--termina paneles de pago -->
                                    </table>
                                    <!--</asp:Panel>-->
