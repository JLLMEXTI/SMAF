            ...
            else if ((fileOk) & (xmlOK))
            {
                ...
                try
                {
                    ...
                    if ((existe == "") | (existe == null))
                    {
                        ...
                        MngNegocioComision.Inserta_Comprobacion_Comision(detalleComision.Oficio, detalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), oXml.FECHA_TIMBRADO, detalleComision.Proyecto, detalleComision.Dep_Proy, dplFiscales.SelectedValue.ToString(), lsClvConcepto, lsConcepto, fuplPDF.FileName, clsFuncionesGral.ConvertString(totalImporteXml), fuplXML.FileName, "01", "01", lsConcepto + "|factura|" + fuplPDF.FileName.Replace(".pdf", ""), fuplPDF.FileName.Replace(".pdf", ""), ticket, oXml.TIMBRE_FISCAL, detalleComision.Periodo);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "18", "CERTIFICADO DE TRANSITO", clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(txtImporteCertificado.Text), "", "01", "01", "CERTIFICADO-" + clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), "", "", DetalleComision.Periodo);
                    // Calcula();
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "19", "01", "01", "SINGLADURAS ", clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(grandTotal.ToString()), "", "SINGLADURAS-" + clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), "", "", DetalleComision.Periodo);
                    // Calcula();
