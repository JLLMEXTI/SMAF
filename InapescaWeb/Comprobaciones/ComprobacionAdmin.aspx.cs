...
{
    public partial class ComprobacionAdmin : System.Web.UI.Page
    {
        string lsFolio;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Session["Crip_Rol"].ToString() != "DIRADMIN")
                {
        ...
        public void Calcula_Reintegro(Comision poComision)
        {
            ...
            if ((oDatosNum.TotalTotalDev > 0) && (oDatosNum.TotalTotalAnt > 0))
            {
                ...
                if (oDatosNum.TotalCompHospedaje > 0)
                {
                    ...
                    double dGastoHospDev = Math.Round(((oDatosNum.TotalCompHospedaje / DiasTotales) * Math.Truncate(oDatosNum.DiasDev)), 2);
                    double dGastoHospAnt = Math.Round(((oDatosNum.TotalCompHospedaje / DiasTotales) * Math.Truncate(oDatosNum.DiasAnt)), 2);
                ...
                if (tReintegro > 0)
                {
                    ...
                    txtreintegro.Text = oDatosNum.TotalImporteReintegro.ToString();
                }
                else 
                {
                    ...
                    oDatosNum.TotalComprobadoDev = oDatosNum.TotalComprobadoDev;
                    lblMonto.Text = oDatosNum.TotalImporteReintegro.ToString("C", CultureInfo.CreateSpecificCulture("es-MX"));
                    txtreintegro.Text = lblMonto.Text = oDatosNum.TotalImporteReintegro.ToString();
                }
            ...
            else
            {
                ...
                else if (poComision.Forma_Pago_Viaticos == Dictionary.VIATICOS_ANTICIPADOS)
                {
                    ...
                    oDatosNum.TotalImporteReintegro = Math.Round(oDatosNum.TotalImporteReintegro, 2);
        ...
        public void Carga_Valores(Comision poComision)
        {
            ...
            Label39.Text = clsFuncionesGral.ConvertMayus("Oficio de Comisión Firmado :");
            ...
            if ((poComision.Territorio == "3") && ((poComision.Zona_Comercial == "7") | (poComision.Zona_Comercial == "8")))
            {
                ...
                //Lista = null;
                Label6.Text = clsFuncionesGral.ConvertMayus("cARGA DE COMPROBANTES DE LA COMISION ") + poComision.Archivo.Replace(".pdf", "");
        ...
        /*
        //sube Oficio
        public void Sube_Oficio_Comision()
        {
            bool fileOk = false;
            string[] lsCadena = new string[2];
            Comision DetalleComision = new Comision();
            if (fupdlComision.HasFile)
            {
                ...
                String fileExtension = System.IO.Path.GetExtension(fupdlOficio.FileName).ToLower();
                String[] allowedExtensions = { ".pdf" };
            ...
            if (fileOk)
            {
                try
                {
                    fupdlOficio.PostedFile.SaveAs(Session["Crip_Ruta"] + "/" + fupdlOficio.FileName);

                    MngNegocioComision.Inserta_Oficio_Comision(DetalleComision, fupdlOficio.FileName);

                    Valida_Oficio(DetalleComision);
                    //   Carga_Detalle();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('Informe de comisión ha subido exitosamente.');", true);
                    DetalleComision = null;
                    return;
        ...
        public void Valida_Informe(Comision poComision)
        {
            ...
            cc = MngNegocioComision.Obtiene_Informe(poComision.Comisionado, poComision.Ubicacion_Comisionado, lsCadena[3], poComision.Dep_Proy, lsCadena[4].Replace(".pdf", ""),poComision.Proyecto);
        ...
        //valida oficicio de comisión con firma
        public void Valida_Oficio(Comision poComision)
        {
            InapescaWeb.Entidades.comision_informe cc;
            string[] lsCadena = new string[5];
            lsCadena = poComision.Archivo.ToString().Split(new Char[] { '-' });
        ...
        public void Crear_Tabla(Comision poComision)
        {
            ...
            {
                Session["DatosInternacional"] = MngNegocioComprobacion.Regresa_ListComprobacion(poComision.Ubicacion_Comisionado, poComision.Comisionado, poComision.Archivo, "0");
                GvInternacional.DataSource = Session["DatosInternacional"];
                GvInternacional.DataBind();
            }
            else
            {
                Session["DatosFiscales"] = MngNegocioComprobacion.Regresa_ListComprobacion(poComision.Ubicacion_Comisionado, poComision.Comisionado, poComision.Archivo, "2");
                GvFiscales.DataSource = Session["DatosFiscales"];
                GvFiscales.DataBind();
            }
            Session["DatosNoFiscales"] = MngNegocioComprobacion.Regresa_ListComprobacion(poComision.Ubicacion_Comisionado, poComision.Comisionado, poComision.Archivo, "3");
                ...
                try
                {
                    ...
                    if ((existe == "") | (existe == null))
                    {
                        ...
                        else
                        {
                            ...
                            string lsComprobado = MngNegocioComprobacion.Total(detalleComision.Comisionado, detalleComision.Ubicacion_Comisionado, detalleComision.Archivo, "'12'");
        ...
        protected void GvInternacional_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            bool X = MngNegocioComision.Update_Estatus_Comprobacion(DetalleComision.Oficio, DetalleComision.Comisionado, DetalleComision.Ubicacion_Comisionado, fechaEliminar, lsImporte, cadenas[2], "2");
            ...
            if (X)
            {
                ...
                MngNegocioComprobacion.Update_Comprobacion(DetalleComision.Ubicacion_Comisionado, DetalleComision.Comisionado, DetalleComision.Archivo, "9", "");
        ...
        protected void GvNoFiscales_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            bool T = MngNegocioComision.Update_Estatus_Comprobacion(DetalleComision.Oficio, DetalleComision.Comisionado, DetalleComision.Ubicacion_Comisionado, fechaEliminar, lsImporte, observaciones, "3");
            if (T)
            {
                MngNegocioComprobacion.Update_Comprobacion(DetalleComision.Ubicacion_Comisionado, DetalleComision.Comisionado, DetalleComision.Archivo, "9", "");
                MngNegocioComision.Update_estatus_Comision("9", DetalleComision.Comisionado, DetalleComision.Oficio, DetalleComision.Ubicacion_Comisionado, DetalleComision.Archivo);
        ...
        protected void lnkAddFacturas_Click(object sender, EventArgs e)
        {
            ...
            if (!clsFuncionesGral.IsNumeric(TbImporteFact.Text))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('favor de insertar valor numerico en el campo Importe');", true);
                return;
            }
            if ((TbImporteFact.Text == "") | (TbImporteFact.Text == null))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('Favor de insertar valor en el campo importe');", true);
                return;
            }
            if (!clsFuncionesGral.IsNumeric(TbMetodoPagoFact.Text))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('favor de insertar valor numerico en metodo de pago');", true);
                return;
            }
            if ((TbMetodoPagoFact.Text == "") | (TbMetodoPagoFact.Text == null))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('Favor de insertar numero en metodo de pago');", true);
                return;
            }
            if ((TbFechaFac.Text == "") | (TbFechaFac.Text == null))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('Favor de insertar fecha de factura');", true);
                return;
            }
            if ((TbUUID.Text == "") | (TbUUID.Text == null))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Inapesca", "alert('Favor de insertar UUID de la factura');", true);
                return;
            }
            ...
            else if ((fileOk) & (xmlOK))
            {
                ...
                try
                {
                    ...
                    string existe = MngNegocioComprobacion.Exist_UUUID(TbUUID.Text.ToString());

                    string sMetodoPago = TbMetodoPagoFact.Text.ToString();
                    if ((existe == "") | (existe == null))
                    {
                        Valida_Carpeta(detalleComision.Ruta, false, true);
                        ...
                        totalImporteXml = clsFuncionesGral.Convert_Double(TbImporteFact.Text.ToString());
                        ...
                        //{
                        //bool sube = MngNegocioXml.Inserta_DetalleXML(detalleComision.Comisionado, detalleComision.Ubicacion_Comisionado, detalleComision.Archivo, fuplXML.FileName, oXml.TIMBRE_FISCAL, oXml.RFC_EMISOR, x.Descripcion, Dictionary.CADENA_NULA, oXml.FECHA_TIMBRADO, x.Codigo, oXml.IVA, oXml.TUA, oXml.ISR, oXml.IEPS, oXml.SFP, oXml.ISH, Dictionary.NUMERO_CERO, Dictionary.NUMERO_CERO, Dictionary.NUMERO_CERO, Dictionary.NUMERO_CERO, Dictionary.NUMERO_CERO, Dictionary.NUMERO_CERO, x.Codigo, clsFuncionesGral.ConvertString(totalImporteXml), Dictionary.NUMERO_CERO, oXml.TOTAL_IMPUESTOS_TRASLADADOS);
                        //}

                        Crear_Tabla(detalleComision);
                        Calcula_Reintegro(detalleComision);
                        detalleComision = null;
                        TbMetodoPagoFact.Text = Dictionary.CADENA_NULA;
                        TbImporteFact.Text = Dictionary.CADENA_NULA;
                        TbUUID.Text = Dictionary.CADENA_NULA;
                        TbFechaFac.Text = Dictionary.CADENA_NULA;
        ...
        private void InsertaComprobacionFiscal(Comision detalleComision, List<Entidad> llEntidad, Entidades.Xml oXml, string lsClvConcepto, string lsConcepto, string ticket, string sMetPago, bool MetodoPagoDif = false)
        {
            ...
            {
                CBoxAcepto.Checked = false;
                string sMetodoPago = Regex.Replace(oXml.METODO_PAGO, @"[^\d]", "");

                if (!clsFuncionesGral.IsNumeric(oXml.METODO_PAGO))
                {

                    if (!clsFuncionesGral.IsNumeric(sMetodoPago))
                    {
                        LblMetodoPago.Text = oXml.METODO_PAGO;
                    }
                    else
                    {
                ...
                {
                    string traeMetPago = MngNegocioComprobacion.Metodo_PagoComprobacion(oXml.METODO_PAGO);
                    if (traeMetPago == "0")
                    {
                        LblMetodoPago.Text = oXml.METODO_PAGO;
                    }
        ...
        protected void lnkAgregaNoFiscal_Click(object sender, EventArgs e)
        {
            ...
            double TotalNofiscal = Convert.ToDouble(MngNegocioComprobacion.Total_AnualNoFiscal(detalleComision.Comisionado));
            ...
            if ((oDatosNum.TotalTotalDev > 0) && (oDatosNum.TotalTotalAnt > 0))
            {
                ...
                else if (detalleComision.Forma_Pago_Viaticos == Dictionary.VIATICOS_ANTICIPADOS)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (Convert.ToDouble(rec.Importe) == oDatosNum.TotalImporteReintegro)
                            {
            ...
            if (bConAmpl == true)
            {
                ...
                if (ListArchivosAmp != null)
                {
                    ...
                    foreach (Entidad r in ListArchivosAmp)
                    {
                        ...
                        DetalleComisionAmp = MngNegocioComision.Obten_Detalle(r.Descripcion, DetalleComision.Ubicacion_Comisionado, DetalleComision.Comisionado, DetalleComision.Estatus);
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (oComision.Comisionado != "0")
            {
                ...
                if (oComision.Estatus == "7" || oComision.Estatus == "5")
                {
                    //clsFuncionesGral.Activa_Paneles(PanelTodo, true, false);
                    clsFuncionesGral.Activa_Paneles(pnlPdfDescarga, true);
                    //LinkDescargaMinistracion.InnerText = "DESCARGAR MINISTRACION";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if ((TbReferenReint.Text == "") | (TbReferenReint.Text == null))
            {
                ClientScript.RegisterStartupScript(this.GetType(), "Inapesca", "alert('Favor de colocar el numero de la referencia bancaria');", true);
                return;
            }
            ...
            if (fupdReintegros.HasFile)
            {
                Valida_Carpeta(DetalleComision.Ruta, false, false, true, false);
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, DetalleComision.Comisionado, DetalleComision.Ubicacion_Comisionado, lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "13", "REINTEGRO", clsFuncionesGral.ConvertMinus(fupdReintegros.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(txtreintegro.Text), "", "01", "01", "Reintegro-" + TbReferenReint.Text.ToString(), clsFuncionesGral.ConvertMinus(fupdReintegros.FileName).Replace(".pdf", ""), "", "", DetalleComision.Periodo);

                    if (TbReferenReint.Text.ToString() != "0")
                    {
                        bool UpdateMontoReferencia = MngNegocioGenerarRef.Update_UpdateReferenciaGenerada(TbReferenReint.Text.ToString(), clsFuncionesGral.Convert_Decimales(txtreintegro.Text), lsHoy);//aqui va el metodo para actualizar la referencia
                    }
