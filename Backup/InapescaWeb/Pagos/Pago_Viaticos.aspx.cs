...
namespace InapescaWeb.Pagos
{
    public partial class Pago_Viaticos : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string lsAdscripcion = dplSiglas.SelectedValue.ToString();
        ...
        protected void btnPagar_Click(object sender, EventArgs e)
        {
            ...
            if (Session["Crip_IsExistinMinistracion"].ToString() == "0")
            {
                ...
                if ((pnlViaticos.Visible) & ((clsFuncionesGral.Convert_Double(oCdetalle.Viaticos) + clsFuncionesGral.Convert_Double(txtViatpag.Text)) ==  clsFuncionesGral.Convert_Double ( DetalleComision.Total_Viaticos )))
                {
                    MngNegocioMinistracion.UpdateEstatusMinistracion("2", DetalleComision.Archivo.Replace(".pdf", ""), lsMinistracion, "17");
                }

                if ((pnlCombustible.Visible) & ((clsFuncionesGral.Convert_Double(oCdetalle.Combustible) + clsFuncionesGral.Convert_Double(txtCombust.Text))== clsFuncionesGral.Convert_Double (DetalleComision.Combustible_Efectivo )))
                {
                    MngNegocioMinistracion.UpdateEstatusMinistracion("2", DetalleComision.Archivo.Replace(".pdf", ""), lsMinistracion, "6");
                }
                
                if ((pnlPeaje.Visible) & ((clsFuncionesGral.Convert_Double(oCdetalle.Peaje) + clsFuncionesGral.Convert_Double(txtPeajePag.Text)))== clsFuncionesGral .Convert_Double (DetalleComision.Peaje ))
                {
                    MngNegocioMinistracion.UpdateEstatusMinistracion("2", DetalleComision.Archivo.Replace(".pdf", ""), lsMinistracion, "7");
                }

                if ((pnlPasajes.Visible) & ((clsFuncionesGral.Convert_Double(oCdetalle.Pasaje) + clsFuncionesGral.Convert_Double(txtPasaje.Text)) == clsFuncionesGral.Convert_Double(DetalleComision.Pasaje)))
                {
                    MngNegocioMinistracion.UpdateEstatusMinistracion("2", DetalleComision.Archivo.Replace(".pdf", ""), lsMinistracion, "8");
                }

                if((pnlSingladuras.Visible ) & ((clsFuncionesGral.Convert_Double(oCdetalle.Singladuras) + clsFuncionesGral.Convert_Double(txtSingladuras.Text))== clsFuncionesGral.Convert_Double (DetalleComision.Singladuras )))
                {
