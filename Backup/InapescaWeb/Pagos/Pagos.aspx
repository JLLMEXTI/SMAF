<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pagos.aspx.cs" Inherits="InapescaWeb.Pagos.Pagos" %>
        ...
        <div id="main">
            ...
            <div id="side-b">
                <table id="Table1" border="0" width="100%" cellspacing="1" cellpadding="1">
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnlListas" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan ="3">
                                        <asp:DropDownList ID="dplOficios" runat="server" Width="100%">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </asp:Panel>
                        ...
                        <ContentTemplate>
                            <tr>
                                <td colspan="6" align="center">
                                    <asp:CheckBox ID="chkBusquedaManual" runat="server" AutoPostBack="True" OnCheckedChanged="chkBusquedaManual_CheckedChanged" />
                                </td>
                            </tr>
                            ...
                            <asp:Panel ID="pnlManual" runat="server">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtNumOficio" runat="server" Width="20%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td  colspan ="3">
                                    ...
                                    <td colspan ="3">
                                        <asp:DropDownList ID="dplAdscripcion1" runat="server" Width="100%">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </asp:Panel>
                    ...
                    <!--termina panel manual-->
                    <tr>
                        <td align="right" colspan ="6">
                            <asp:Button ID="btnBuscar" runat="server" Text="Button" Width="30%" 
                    ...
                    <tr>
                        ...
                        <!--panel de pagos-->
                            <asp:Panel ID="pnlPagos" runat="server">
                                ...
                                <tr>
                                <td colspan = "2">
                                 <b>   <asp:Label ID="lblNombre" runat="server" Text="Label"></asp:Label> </b>
                                </td>
                                <td  colspan = "2">
                                    <b><asp:Label ID="lblLugarComison" runat="server" Text="Label"></asp:Label> </b>
                                </td>
                                <td colspan = "2">
                                    <b> <asp:Label ID="lblPeriodo" runat="server" Text="Label"></asp:Label> </b>
                                </td>
                                </tr>
                                ...
                                <!--termina datos de comision-->
                                   <tr>
                                    ...
                                    <tr>
                                                ...
                                                <td align="right">
                                                    <asp:Button ID="btnPagar" runat="server" Text="Button" 
