<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Comision_Comprobacion.aspx.cs"
    Inherits="InapescaWeb.Comprobaciones.Comision_Comprobacion" %>
                            ...
                            <asp:Panel ID="pnlInforme" runat="server">
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:FileUpload ID="fupdlComision" runat="server" Width="85%" />
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnlFiscales" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="dplFiscales" runat="server" Width="85%" AutoPostBack="True"
                            ...
                            <asp:Panel ID="pnlNoFiscales" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtConcepto" runat="server" Width="85%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtImporte" runat="server" Width="85%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtObservaciones" runat="server" Width="85%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="right">
                            ...
                            <asp:Panel ID="pnlFacturas" runat="server">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="dplConcepto" runat="server" Width="85%" AutoPostBack="True"
