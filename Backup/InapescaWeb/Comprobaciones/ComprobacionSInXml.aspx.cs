            ...
            if ((fileOk) & (xmlOK))
            {
                ...
                try
                {
                    ...
                    if ((existe == "") | (existe == null))
                    {
                        ...
                        sube = MngNegocioComision.Inserta_Comprobacion_Comision(detalleComision.Oficio, detalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), TextBox1.Text, detalleComision.Proyecto, detalleComision.Dep_Proy, dplFiscales.SelectedValue.ToString(), lsClvConcepto, lsConcepto, fuplPDF.FileName, clsFuncionesGral.ConvertString(totalImporteXml), fuplXML.FileName, lsConcepto + "|factura|" + fuplPDF.FileName.Replace(".pdf", ""), fuplPDF.FileName.Replace(".pdf", ""), "", txtUUID.Text,detalleComision.Periodo);
                        Crear_Tabla();
                        tblDetalle.Rows.Clear();
                        Carga_Detalle(detalleComision);
                        detalleComision = null;
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "12", "CERTIFICADO DE TRANSITO", clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(txtImporteCertificado.Text), "", "CERTIFICADO-" + clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdCertificado.FileName).Replace(".pdf", ""), "", "",DetalleComision.Periodo);
                    // Calcula();
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                try
                {
                    ...
                    MngNegocioComision.Inserta_Comprobacion_Comision(DetalleComision.Oficio, DetalleComision.Archivo, Session["Crip_Usuario"].ToString(), Session["Crip_Ubicacion"].ToString(), lsHoy, DetalleComision.Proyecto, DetalleComision.Dep_Proy, "3", "12", "DESPACHO DE CAPITANIA DE PUERTO", clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), clsFuncionesGral.Convert_Decimales(grandTotal.ToString()), "", "DESPACHO-" + clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), clsFuncionesGral.ConvertMinus(fupdDespacho.FileName).Replace(".pdf", ""), "", "",DetalleComision.Periodo );
                    // Calcula();
