...
namespace InapescaWeb.Reportes
{
    public partial class ReporteXproyecto : System.Web.UI.Page
    {
        ...
        public void Carga_Valores()
        {
            ...
            dplDireccion.DataSource = MngNegocioDirecciones.ObtienenDirecciones(Year);
            ...
            dplUnidades.DataTextField = "Descripcion";
            dplUnidades.DataValueField = "Codigo";
            ...
            chkUnidad.Text = clsFuncionesGral.ConvertMayus("Desglose por unidades administrativas");
            btnBuscar.Text = "Buscar";
            btnBuscar.Enabled = false;

            Label1.Text = clsFuncionesGral.ConvertMayus("filtros de reporte balance por proyectos");
            Label2.Text = clsFuncionesGral.ConvertMayus("Direcciones");
            Label3.Text = clsFuncionesGral.ConvertMayus("Unidades Administrativas");
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            if (pnlDirecciones.Visible)
            {
               ...
               /* else if (lsDep == "10")
                ...
                listaProgramsDirecciones = MngNegociosProgramas.Obtiene_Programas(lsDep);

                pnlBarDatos.Items.Clear();

                if (listaProgramsDirecciones.Count > 0)
                {
                    //metodo para los programas de todas las direcciones
                    if (dplDireccion.SelectedValue.ToString() == "10")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            TotalPrograma = clsFuncionesGral.Convert_Double ( obj.Presupuesto);
                            ...
                            //calculo de proyectos por crips
                            ListaProyectoAdscripcion = MngNegocioProyecto.ListaProyectoAdcripcion(dplDireccion.SelectedValue.ToString(), obj.Id_Programa);
                           ...
                           // controls1.Append("<td style='text-align: center'> Importe Comprobado Calculado </td>");
                            ...
                            foreach (Entidad x in ListaProyectoAdscripcion)
                            {
                                ...
                                controls.Append(" <tr >");
                                controls.Append("<td >" + MngNegocioDependencia.Centro_Descrip(x.Descripcion) + "</td>");

                                ListaComisiones = MngNegocioComisionDetalle.ListaComisiones(x.Codigo, x.Descripcion, "2", lsInicio, lsFin);

                                if (ListaComisiones.Count == 0)
                                {
                                    controls.Append("<td > " + clsFuncionesGral.Convert_Decimales(Dictionary.NUMERO_CERO) + "</td>");
                                    controls.Append("<td > " + clsFuncionesGral.Convert_Decimales(Dictionary.NUMERO_CERO) + "</td>");
                                    controls.Append("<td > " + clsFuncionesGral.Convert_Decimales(Dictionary.NUMERO_CERO) + "</td>");
                                }
                                else
                                {
                                    ...
                                    ListaSolicitado = MngNegocioComisionDetalle.ListaComisiones(x.Codigo, x.Descripcion, "", lsInicio, lsFin);
                            ...
                            gf.ChartTitle.Text = "Grafica Balance de proyecto " + obj.Descripcion;
                            ...
                            tp.Y = Convert.ToDecimal(TotalPrograma);
                            ...
                            tc.Y = Convert.ToDecimal(TotalSolicitado);
                           
                        
                            tc.BackgroundColor = Color.SteelBlue;
                            ...
                            di.Y = Convert.ToDecimal(((TotalPagado - TotalComprobado) * 100) / clsFuncionesGral.Convert_Double(obj.Presupuesto));// - (((TotalComprobado * 100) / TotalPagado)));
                            ...
                            d2.Y = Convert.ToDecimal(100 - (TotalPagado * 100) / (clsFuncionesGral.Convert_Double(obj.Presupuesto)));
                            ...
                            else d3.Y = Convert.ToDecimal((TotalComprobado * 100) / clsFuncionesGral.Convert_Double(obj.Presupuesto));
            ...
            else if (pnlUnidades.Visible)
            {
                ...
                else
                {
                    ...
                    //aca mero
                    listaProgramsDirecciones = MngNegociosProgramas.Obtiene_Programas(lsDep , "", true);
                    ...
                    if (listaProgramsDirecciones.Count > 0)
                    {
                        foreach (Programa x in listaProgramsDirecciones)
                        {
                            ...
                            ListaComisiones = MngNegocioComisionDetalle.ListaComisiones(x.Id_Programa, lsDep , "2", lsInicio, lsFin);

                            //proceso de solicitado
                            ListaSolicitado = MngNegocioComisionDetalle.ListaComisiones(x.Id_Programa, lsDep , "", lsInicio, lsFin);
