<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ministracion.aspx.cs" Inherits="InapescaWeb.Ministraciones.Ministracion" %>
            ...
            <div id="side-b">
                        ...
                        <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="left">
                                    <asp:DropDownList ID="dplPrograma" runat="server" Width="85%">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="left">
                                    <asp:DropDownList ID="dplTipoMinistracion" runat="server" Width="85%" AutoPostBack="True"
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="2">
                                    <asp:DropDownList ID="dplTipoPago" runat="server" Width="85%" AutoPostBack="True"
                   ...
                   <!-- <asp:Panel ID="pnlBusquedaProv" runat="server">-->
                      ...
                      <!--  <asp:Panel ID="pnlBuscaXRFC" runat="server">-->
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="left">
                                    <asp:TextBox ID="txtRfcFind" runat="server" Width="85%"></asp:TextBox>
                    ...
                    <asp:Panel ID="pnlBuscarxXML" runat="server">-->
                            ...
                            <tr>
                                <td colspan="2" style="width: 50%; text-align: left">
                                    <asp:FileUpload ID="fuplPDF" runat="server" Width="85%" />
                                </td>
                                <td colspan="2" style="width: 50%; text-align: left">
                                    <asp:FileUpload ID="fuplXML" runat="server" Width="85%" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="width: 50%; text-align: left">
                                ...
                                <td colspan="2" style="width: 50%; text-align: left">
                                    <asp:FileUpload ID="fupdTickets" runat="server" Width="85%" />
                                </td>
                            </tr>
                            <tr>
             ...
             <!-- <asp:Panel ID="pnlProovedor" runat="server"> -->
                        ...
                        <tr>
                            ...
                            <td align ="left">
                                <asp:TextBox ID="txtRfc" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td  align ="right";>
                                <b>
                            ...
                            <td style ="width :25%;" align="left">
                                <asp:TextBox ID="txtCp" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                      <tr>
                            <td align="right">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCalle" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtContacto" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="txtNumExt" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtTelefonoCon" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="txtNumInt" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtTelefonoEmpresa" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="txtColonia" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtTelefonoEmpresa2" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="txtMunicipio" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtRegimenFiscal" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="txtCuidad" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtServicio" runat="server" Width="85%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td>
                                <asp:TextBox ID="txtEstado" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td colspan="2">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPais" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right" colspan="2">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCuentaBancaria" Width="85%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right">
                                <b>
                            ...
                            <td>
                                <asp:TextBox ID="txtBanco" Width="85%" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="center">
                                <asp:TextBox ID="txtClabe" runat="server" Width="85%"></asp:TextBox>
                            </td>
                            <td align="right" colspan="2">
                                <h2>
                ...
                <!-- </asp:Panel>-->
                    ...
                    <asp:Panel ID="pnlAgregaFac" runat="server">
                        ...
                        <tr>
                            <td colspan="2" style="width: 50%; text-align: left">
                                <asp:FileUpload ID="FileUpload1" runat="server" Width="85%" />
                            </td>
                            <td colspan="2" style="width: 50%; text-align: left">
                                <asp:FileUpload ID="FileUpload2" runat="server" Width="85%" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="width: 50%; text-align: left">
                            ...
                            <td colspan="2" style="width: 50%; text-align: left">
                                <asp:FileUpload ID="FileUpload3" runat="server" Width="85%" />
                            </td>
                        </tr>
                    </asp:Panel>
                    <tr>
